...
function portfolio_register_settings() {
  ...
  add_settings_section(
    'portfolio-social-settings',
    __('Portfolio Social Settings', 'leotoikka'),
    'portfolio_social_description',
    'portfolio_social_settings'
  );

  add_settings_field(
    'profile-picture',
    __('Profile Picture', 'leotoikka'),
    'portfolio_settings_profile_picture',
    'portfolio_social_settings',
    'portfolio-social-settings'
  );
  ...
  add_settings_field(
    'twitter-handler',
    __('Twitter URL', 'leotoikka'),
    'portfolio_settings_twitter_handler',
    'portfolio_social_settings',
    'portfolio-social-settings'
  );
  ...
  add_settings_field(
    'facebook-handler',
    __('Facebook URL', 'leotoikka'),
    'portfolio_settings_facebook_handler',
    'portfolio_social_settings',
    'portfolio-social-settings'
  );
  ...
  add_settings_field(
    'github-handler',
    __('Github URL', 'leotoikka'),
    'portfolio_settings_github_handler',
    'portfolio_social_settings',
    'portfolio-social-settings'
  );
  ...
  add_settings_field(
    'linkedin-handler',
    __('LinkedIn URL', 'leotoikka'),
    'portfolio_settings_linkedin_handler',
    'portfolio_social_settings',
    'portfolio-social-settings'
  );

  add_settings_section(
    'portfolio-page-settings-home',
    __('Portfolio Home Page Settings', 'leotoikka'),
    'portfolio_home_description',
    'portfolio_home_settings'
  );
  ...
  add_settings_field(
    'home-content',
    __('Home Page Text', 'leotoikka'),
    'portfolio_settings_home_page_text',
    'portfolio_home_settings',
    'portfolio-page-settings-home'
  );
  ...
  add_settings_field(
    'home-picture',
    __('Home Page Picture', 'leotoikka'),
    'portfolio_settings_home_page_picture',
    'portfolio_home_settings',
    'portfolio-page-settings-home'
  );
}
